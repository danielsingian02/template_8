	...
	<div class="img-text-container">
		<div class="img-text">
			...
			<div class="content-text">
				...
				<img class="content-text-img" src="<?php echo get_theme_mod('second_image',get_bloginfo('template_directory').'/assets/images/Asset 1 template 8 1.png' )?>" border="0" alt="">
			</div>
		...
		<div class="img-text">
			...
			<div class="content-text--second flex-column">
				...
				<img class="content-text-img" src="<?php echo get_theme_mod('second_image',get_bloginfo('template_directory').'/assets/images/Asset 2 1.png' )?>" border="0" alt="">
			</div>
		</div>
	</div>
